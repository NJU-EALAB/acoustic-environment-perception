...
dataPath0 = '../data/kjg511_20221010.mat';
...
switch 2
    ...
    case 2
       %% real pos in 511
        ...
        [refMicPos(1,:),refMicPos(2,:),refMicPos(3,:)] = sph2cart(micParams.azi(refMicIdx),micParams.ele(refMicIdx),micParams.radius);
        refMicPos = ESMAPos+refMicPos;
        pos = [1.31574639149334,0,1.20000000000000;1.31574639149334,-0.545000000000000,1.20000000000000;0.930373195746668,-0.930373195746668,1.20000000000000;0.545000000000000,-1.31574639149334,1.20000000000000;0,-1.31574639149334,1.20000000000000;-0.545000000000000,-1.31574639149334,1.20000000000000;-0.930373195746668,-0.930373195746668,1.20000000000000;-1.31574639149334,-0.545000000000000,1.20000000000000;-1.31574639149334,0,1.20000000000000;-1.31574639149334,0.545000000000000,1.20000000000000;-0.930373195746668,0.930373195746668,1.20000000000000;-0.545000000000000,1.31574639149334,1.20000000000000;0,1.31574639149334,1.20000000000000;0.545000000000000,1.31574639149334,1.20000000000000;0.930373195746668,0.930373195746668,1.20000000000000;1.31574639149334,0.545000000000000,1.20000000000000];
        x = pos(:,1).';
        y = pos(:,2).';
        z = pos(:,3).';
        srcPosReal = [x;y;z];
