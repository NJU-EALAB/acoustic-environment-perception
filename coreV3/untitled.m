...
c = 343;
srcSelectIdx = [1];
srcRealSelectIdx = [1:4];
ESMAPos = [0.72;0;0.93];%gulou litang
refMicPos = ESMAPos+[0;-1;0];%gulou litang
refMicIdx = 17;

dataPath0 = '../ESMA_Measurement/20230522_16_14_11.mat';
dataPath1 = {dataPath0,'../ESMA_Measurement/20230522_17_03_39.mat','../ESMA_Measurement/20230522_17_17_47.mat','../ESMA_Measurement/20230522_17_22_22.mat'};
chIdx = [1:16];
for ii = 1:numel(dataPath1)
    dataPath = mergeData(ita2irm(dataPath1{ii},1),chIdx,1);
